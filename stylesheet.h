...
void applyPinkPalette(QApplication &app) {
    ...
    palette.setColor(QPalette::PlaceholderText, QColor("#A38A90"));
    ...
    palette.setColor(QPalette::Disabled, QPalette::WindowText, QColor("#A39396"));
    palette.setColor(QPalette::Disabled, QPalette::Button, QColor("#E0D0D3"));
    palette.setColor(QPalette::Disabled, QPalette::ButtonText, QColor("#A39396"));
